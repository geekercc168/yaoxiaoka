<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:56:"/www/wwwroot/yaoxiaoka/application/pc/view/about/ze.html";i:1614933378;s:62:"/www/wwwroot/yaoxiaoka/application/pc/view/common/mheader.html";i:1614909815;s:61:"/www/wwwroot/yaoxiaoka/application/pc/view/common/header.html";i:1621324688;s:58:"/www/wwwroot/yaoxiaoka/application/pc/view/common/nav.html";i:1624612117;s:62:"/www/wwwroot/yaoxiaoka/application/pc/view/common/mfooter.html";i:1620488383;s:61:"/www/wwwroot/yaoxiaoka/application/pc/view/common/footer.html";i:1632456108;}*/ ?>
<?php if($is_mobile==1): ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container" style="padding: 15px">
    <div class="news_con">
        ...
        <span style="color: #5877fb"><b>要销卡提醒您：</b>
        在使用要销卡之前，请您务必仔细阅读并透彻理解本声明。<br />
        您可以选择不使用要销卡，如果您选择使用，您的使用行为将被视为对本声明全部内容的认可。
        </span><br /><br /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;<b>要销卡</b>对本网站上所有内容包括但不限于网站运营或本网站上的信息、内容、材料或产品，不提供明示或暗示的担保。由所适用法律许可，要销卡否认所有明示或暗示的担保，包括但不限于为特定目的做的商务暗示担保。<br /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;本网站不希望出现任何因交易而与用户之间产生纠纷，但并不保证不发生该类纠纷。对于因前述各类情形而产生的任何纠纷，将由交易方依据中华人民共和国现行的有关法律通过适当的方式直接加以解决，本网站及其所有者不参与其中；对于因此类交易而产生的各类纠纷之任何责任和后果，由交易方承担，本网站及其所有者不承担任何责任及后果。如果任何单位或者个人通过上述“信息”而进行任何交易或者进行其他行为，须得知网络交易、网上行为的风险性，进行交易或行为的事前辨别和采取谨慎的预防措施，要销卡对任何损失或任何由于使用本网站而引起的损失，包括但不限于直接的，间接的，偶然的、惩罚性的和引发的损失，不承担责任。<br /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;除与要销卡有另行书面约定的服务外，您应该对使用要销卡的结果自行承担风险，一切因使用要销卡而可能遭致的意外、侵权及其他损失（包括下载被搜索链接到的第三方网页中的内容被感染电脑病毒等），因网络状况、通讯线路、电力故障、第三方网站等任何原因而导致您不能正常使用要销卡，要销卡对其概不负责，亦不承担任何法律责任。<br />
            &nbsp;&nbsp;&nbsp;&nbsp;本服务协议双方为本网站与使用本网站账号交易服务用户。若因违反此协议内容所造成的损失由违约人承担全部责任，并赔偿购买人的损失（违约金等）。<br /><br />
            &nbsp;&nbsp;&nbsp;&nbsp;本公司主要是一家从事第二类增值电信业务中的在线数据处理与交易处理业务（仅限经营类电子商务不含互联网金融、网络预约出租汽车服务）、凭许可证从事利用信息网络进行网络游戏虚拟货币交易的公司。该网站“要销卡”是我公司注册用来为用户回收来路合法的网游游戏充值卡或话费充值卡。该网络平台需实名才能进行兑换卡密和提现，本公司也无法查证兑换卡密的安全性问题，因此严禁提交来源非法点卡，用户必须对自己的寄售行为承担法律责任。本站仅提供寄售中介服务，对于兑换卡密的安全性问题由用户本人自己负责。由于兑换卡密的安全性引发的一切法律责任与本公司无关。<br /><br />
        </p>
    </div>
    <?php if($is_mobile!=1): ?>
    <div class="news_right">
        <div class="service_list">
            ...
            <a href="/about/ze" class="active" target="_blank" rel=“nofollow”>免责申明</a>
