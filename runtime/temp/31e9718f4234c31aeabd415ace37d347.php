<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:65:"/www/wwwroot/yaoxiaoka/application/pc/view/help/article_list.html";i:1626947791;s:62:"/www/wwwroot/yaoxiaoka/application/pc/view/common/mheader.html";i:1614909815;s:61:"/www/wwwroot/yaoxiaoka/application/pc/view/common/header.html";i:1621324688;s:58:"/www/wwwroot/yaoxiaoka/application/pc/view/common/nav.html";i:1624612117;s:62:"/www/wwwroot/yaoxiaoka/application/pc/view/common/mfooter.html";i:1620488383;s:61:"/www/wwwroot/yaoxiaoka/application/pc/view/common/footer.html";i:1632456108;}*/ ?>
<?php if($is_mobile==1): ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
layui.use(['table','form'], function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'title',width:340, title: '标题',templet: function (d) {
                    return "<div style='text-align: left !important;'>"+d.title+"</div>"
              } }
     ,{field:'categ_name',width:80, title: '类别',unresize: true }
      ,{field:'pub_time',width:180, title: '发布时间',unresize: true ,sort: true,templet:'#pub_time'}
      ,{field:'', width:80, title: '操作',unresize: true,templet: '#caozuo' }
    ]]
    ,id: 'testReload'
    ,page: true
    ,limit: 15
...
//              area: ['99%', '99%'],
//              shade: 0.8,
//              content: '/ninfo?t=3&id='+id,
//          });
            $.get('/ninfo?t=3&id='+id, {'show':1}, function(res){
                layer.open({
                    // type: 1,
