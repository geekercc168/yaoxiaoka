<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/wwwroot/yaoxiaoka/application/admin/view/article/add_message.html";i:1598423338;s:64:"/www/wwwroot/yaoxiaoka/application/admin/view/common/header.html";i:1614909998;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="width: 670px">
            <input type="number" name="uid" id='uid' value="<?php echo !empty($item['uid'])?$item['uid'] : ''; ?>" lay-verify="required"
    ...
    //Demo
        ...
        layui.use(['layer', 'form', 'table'], function () {
            ...
            form.on('submit(formDemo)', function (data) {
                $.post("/admin/Article/add_message", $('.layui-form').serialize(), function (data) {
                    if (data.code == 1) {
