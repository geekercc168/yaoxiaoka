<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"/www/wwwroot/yaoxiaoka/application/pc/view/help/question_list.html";i:1624612618;s:62:"/www/wwwroot/yaoxiaoka/application/pc/view/common/mheader.html";i:1614909815;s:61:"/www/wwwroot/yaoxiaoka/application/pc/view/common/header.html";i:1621324688;s:58:"/www/wwwroot/yaoxiaoka/application/pc/view/common/nav.html";i:1624612117;s:62:"/www/wwwroot/yaoxiaoka/application/pc/view/common/mfooter.html";i:1620488383;s:61:"/www/wwwroot/yaoxiaoka/application/pc/view/common/footer.html";i:1632456108;}*/ ?>
<?php if($is_mobile==1): ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="layui-container" style="min-height: 450px;"> 
  <div class="layui-row">
...
<script>
    ...
    layui.use(['table','form'], function(){
        ...
        form.on('switch(change)', function(obj){
            ...
            $.post("/admin/article/question_on",{id:id,type:type},function(data){
                layer.msg(data.msg);
            },'json')
        });
        //监听删除编辑操作
        table.on('tool(LAY_table_user)', function(obj){
            ...
            if(layEvent === 'info'){ //编辑
                ...
                //  area: ['90%', '90%'],
                //  shade: 0.8,
                //  content: '/ninfo?t=2&id='+id,
                // });
                $.get('/ninfo?t=2&id='+id, {'show':1}, function(res){
                    layer.open({
                        // type: 1,
