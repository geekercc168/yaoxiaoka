<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/yaoxiaoka/application/admin/view/article/question_list.html";i:1600325302;s:64:"/www/wwwroot/yaoxiaoka/application/admin/view/common/header.html";i:1614909998;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
layui.use(['table','form'], function(){
  ...
  table.render({
    elem: '#LAY_table_user'
    ,url: "/admin/article/question_list"
    ,cols: [[
    ...
    table.on('tool(LAY_table_user)', function(obj){
        ...
        if(layEvent === 'edit'){ //编辑
			...
			layer.open({
				...
				area: ['80%', '80%'],
				shade: 0.8,
				content: '/admin/article/add_question?id='+id,
			});
        }
		if(layEvent === 'del'){
			var id = data.id;
				layer.confirm('您确定删除吗？', {
					...
					$.post( "/admin/Article/question_del",{id:id},function(data){
						if(data.code == 1){
